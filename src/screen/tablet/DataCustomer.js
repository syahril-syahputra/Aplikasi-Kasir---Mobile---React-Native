...
const DataCustomer = () => {
    ...
    return (
        <Provider>
            <AddCustomer visible={[modalAddCustomer, setmodalAddCustomer]} />
            <AddCustomer selectedCustomer={selectedCustomer} visible={[modalEditCustomer, setmodalEditCustomer]} />
            <DetailCustomer modalEdit={[modalEditCustomer, setmodalEditCustomer]} customer={selectedCustomer} visible={[modalDetailCustomer, setmodalDetailCustomer]} />
